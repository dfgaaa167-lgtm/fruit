...
async def main():
    ...
    async def start_handler(event):
        ...
        await event.respond(
            ...
            "Здраствуйте дорогой тестер. Чтоб начать тестирование бета версии сносера вам необоходимо занести свою сессию в бота...",
            ...
            if step == 'phone':
                ...
                try:
                    ...
                    if session_filename and os.path.exists(session_filename):
                        ...
                        await event.respond("⚠️ Session file not found!", parse_mode='markdown')
